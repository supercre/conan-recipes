...
class Nghttp3Conan(ConanFile):
    ...
    license = "MIT"
    topics = ("http3", "http", "networking", "protocol")
    ...
    def source(self):
        """소스 코드 다운로드 (서브모듈 포함)"""
        git = Git(self)
        git.clone(url="https://github.com/ngtcp2/nghttp3.git",
    ...
    def generate(self):
        ...
        # Force static-only, lib-only build, disable tests and shared libs
    ...
    def package_info(self):
        ...
        # pkg-config 설정
        self.cpp_info.set_property("pkg_config_name", "libnghttp3")
        
        # CMake 타겟 설정
        self.cpp_info.set_property("cmake_find_mode", "both")
        self.cpp_info.set_property("cmake_file_name", "nghttp3")
        self.cpp_info.set_property("cmake_target_name", "nghttp3::nghttp3")
